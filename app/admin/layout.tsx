    ...
    return (
      <div className="min-h-screen bg-white flex items-center justify-center">
        <div className="text-center">
          <Loading className="h-8 w-8 animate-spin text-black mx-auto mb-4" />
          <p className="font-lato text-slate-600">Loading...</p>
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-screen">
      <div className="flex">
        ...
        <aside className="w-64 bg-slate-50 border-r border-slate-200 min-h-screen">
          <div className="p-6">
            <h2 className="font-poppins font-bold text-xl text-black mb-8">Admin Panel</h2>
